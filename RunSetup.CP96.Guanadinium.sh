...
### Debugging Options ###
#########################
Db=1 #Debugging 1, REAL RUNS WIH 0
...
Wellcount=96 #Total number of wells to run on each tray
...
molarminFA=0.00 #[range >=0], v1.1=2.0, Minimum mmol of formic acid (sum reagent 5 and 6)
molarmaxFA=6.0 #[range < molarminFA], v1.1=5.0, Maximum mmol of FAH (sum reagent 5 and 6) ##Lower if you get high volume errors
...
MaximumWell=750  #[range > MaximumStock] v1.1=700, Total maximum volume permitted in any well after all reagents added

##########################
### Optional Variables ###
##########################
#molarmax1=0.575 #[range >molarmin1] v1.1=default (this option was not set), Manually set the upper bound for mmol of PbI2 in each well.  Default is 100% stockA, limited by the concentration of stock solution A

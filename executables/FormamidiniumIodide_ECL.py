...
#################################
lab = 'ECL'                           # Options are "LBL" or "HC" (Haverford College), or ECL (pending dev)
wellcount = 12                       # (#)    [range <96] Total number of experimental wells to run on the plate 
...
reag2_target_conc_chemical2 = 1.81     # PbI2 stock concentration target molarity [M] [range > 0] v1.1) in the final solution (not accounting for non-idea solvent behavior)

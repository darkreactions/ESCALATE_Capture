...
reag2_target_conc_chemical2 = 4.6      # PbI2 target molarity [M] [range > 0] v1.1) in the final solution (not accounting for non-idea solvent behavior)
reag2_target_conc_chemical3 = 5.75      # Amine 1  target molarity [M]
...
reag3_target_conc_chemical3 = 11     # Amine 1  target molarity [M]

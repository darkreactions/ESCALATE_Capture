...
reag2_target_conc_chemical2 = 3.80     # PbI2 stock concentration target molarity [M] [range > 0] v1.1) in the final solution (not accounting for non-idea solvent behavior)
reag2_target_conc_chemical3 = 4.75     # Amine 1  target molarity [M]
...
reag3_target_conc_chemical3 = 2.72      # Amine 1  target molarity [M]

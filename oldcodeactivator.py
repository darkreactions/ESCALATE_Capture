...
# Plotting options
ploton=1                              #Setting this value to "1" turns on plotting on
...
chem2_molarmax = 1.535                 # Upper [M] molar concentration for chemical2 in any given portion for all experiments

#chemical 3 (Amine1)
chem3_abbreviation = 'BenzylammoniumIodide' # Abbreviation from chemical list https://goo.gl/UZSCBj  #Ensure: https://goo.gl/UZSCBj present, Reagent 2 amine
chem3_molarmin = 0.0                  # Lower [M] molar concentration for chemical3 in any given portion for all experiments
chem3_molarmax = 1.535                  # Upper [M] molar concentration for chemical3 in any given portion for all experiments 
...
chem5_molarmax = 5.9                  # Upper [M] molar concentration for chemical3 in any given portion for all experiments 
...
reag2_target_conc_chemical2 = 3.07     # PbI2 target molarity [M] [range > 0] v1.1) in the final solution (not accounting for non-idea solvent behavior)
reag2_target_conc_chemical3 = 3.07     # Amine 1  target molarity [M]
...
reag3_target_conc_chemical3 = 2.60     # Amine 1  target molarity [M]
...
#    expgenerator.datapipeline(rxndict)
    ...
    #####################################
    # Use this as a fallback - only god knows what it does

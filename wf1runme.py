...
exp1_vols = [[700,700],[100,250]]                # Volume allocated to each list in the the exp.  For instance [500,250] would mean a total final volume of 750uL
...
temperature2_nominal = 75             #[range 25-120, 105] v1.1=105, Temperature to set the robot for the ITC process
...
#chem2_molarmin = 0.0                  # Lower [M] molar concentration for chemical2 in any given portion for all experiments
...
reag2_target_conc_chemical2 = 1.50     # PbI2 target molarity [M] [range > 0] v1.1) in the final solution (not accounting for non-idea solvent behavior)
